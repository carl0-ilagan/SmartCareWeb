  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pale-stone via-white to-pale-stone flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-md">
        ...
        <div className="mb-6">
          <h1
            className="text-7xl md:text-8xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-graphite via-soft-amber to-graphite animate-shimmer"
            style={{
        ...
        >
          <button
            onClick={() => {
              try {
                const last = typeof window !== "undefined" ? sessionStorage.getItem("lastAllowedPath") : null
                if (last) {
                  router.push(last)
                } else {
                  router.back()
      ...
      <style jsx>{`
        ...
        /* Subtle glow pulse on lock ring */
        @keyframes glowPulse {
