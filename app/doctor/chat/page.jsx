            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-drift-gray flex items-center">
                  {formatLastActive(patientOnlineStatus.lastActive, patientOnlineStatus.isOnline) === "Active now" ? (
                    <>
                      <span className="mr-1 h-2 w-2 rounded-full bg-green-500 inline-block"></span>
                      Active now
                    </>
                  ) : (
                    <>{formatLastActive(patientOnlineStatus.lastActive, patientOnlineStatus.isOnline)}</>
                  )}
                </p>
              </div>
            </div>
