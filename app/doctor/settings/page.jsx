...
import { Lock, Shield, Calendar, Clock, Monitor, Smartphone, Globe, LogOut, Smartphone as DeviceIcon, CheckSquare, Square, MapPin } from "lucide-react"
...
export default function DoctorSettingsPage() {
  ...
  // Refresh devices when settings change
  useEffect(() => {
    if (!user || loading) return
    const refreshDevices = async () => {
      try {
        const trustedDevices = await getTrustedDevices(user.uid)
        setDevices(trustedDevices)
      } catch (error) {
    ...
    refreshDevices()
  }, [settings.security.twoFactor, user, loading])
